      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-400 text-xs leading-relaxed">
              Find Your Court. Book Your Game. Platform reservasi lapangan olahraga paling modern, cepat, dan tanpa ribet.
            </p>
          ...
          {/* Olahraga */}
          <div>
            <h4 className="text-white font-bold mb-4">Jenis Olahraga</h4>
          ...
          {/* Navigasi */}
          <div>
            <h4 className="text-white font-bold mb-4">Layanan Customer</h4>
            <ul className="space-y-2 text-xs">
              <li><a href="#courts" className="hover:text-white transition-colors">Cari Lapangan</a></li>
              <li><a href="#availability" className="hover:text-white transition-colors">Cek Jam Available</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Syarat & Ketentuan Booking</a></li>
        ...
        <div className="mt-12 pt-6 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500">
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <span className="flex items-center gap-1"><ShieldCheck className="w-4 h-4 text-sportgreen" /> Validasi Anti Double-Booking</span>
          </div>
        </div>
      </div>
    </footer>
