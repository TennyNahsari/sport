    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-4 bg-white p-6 rounded-card border border-slate-200 shadow-sm h-fit">
          <h3 className="font-extrabold text-navy text-lg mb-4">{t('addSportHeading')}</h3>
          <form onSubmit={handleAddSport} className="space-y-3 text-xs">
            <div>
              <label className="block font-bold text-slate-700 mb-1">{t('sportNameLabel')}</label>
              <input
                type="text"
                required
                placeholder="Squash"
            ...
            <div>
              <label className="block font-bold text-slate-700 mb-1">{t('shortDescLabel')}</label>
              <textarea
                rows={3}
        ...
        <div className="md:col-span-8 bg-white rounded-card border border-slate-200 shadow-sm p-6">
          <h3 className="font-extrabold text-navy text-lg mb-4">{t('sportsListHeading')}</h3>
